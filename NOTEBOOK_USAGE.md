...
display(artifacts.numeric_report.head())
...
config_df = {
    ...
    "non_features_list": ["customer_id", "target", "cohort_month"],
    "categorical_variables": ["sector", "product_type", "signup_channel", "region_cluster"],
    "special_values": [-999],
